...
import { Course, generateSemesters, SemesterCode, StudentPlan } from '../modules/common/data';
import SemesterBlockList, { ScrollDirection } from '../components/common/SemesterBlockList';
        ...
        <div className="lg:flex h-screen">
          <section className={styles.heroBox}>
            <nav className={styles.navBar}>
              {/* <Link className={styles.navBarItem} href="#overview">
                Overview
              </a>
