...
class CollectionRequirement(BaseModel):
    ...
    name: str
    required: int
    options: list[Annotated[Union[CourseRequirement, SectionRequirement, MajorRequirement, MinorRequirement, ExamRequirement, GPARequirement, HoursRequirement, LimitRequirement, ConsentRequirement, CoreRequirement, OtherRequirement, 'CollectionRequirement'], Field(discriminator='type')]]
