...
export default function Privacy({
  ...
  return (
    <div className="animate-intro">
      <h2 className="text-3xl text-center font-bold mb-2 text-gray-800">
        Privacy Setting
      </h2>
      <h3 className="text-lg text-center font-medium mb-10">
        Before we get started, help us answer a few questions so we can get your
        permission for...
      </h3>
      ...
      <div className="flex-col items-center">
        ...
        <h2 className="ml-9 mb-5 text-gray-700 text-sm">
          Allow us to collect information about you for a more personalized user
          experience
        </h2>
      </div>
      ...
      <div className="flex-col items-center">
        ...
        />
        <h2 className="ml-9 mb-5 text-gray-700 text-sm">
          Automatically report problems/ bugs to our team so we can improve your
          experience
        </h2>
      </div>
