 ...
 */
export default function AuthPage({ providers, csrfToken }: InferGetServerSidePropsType<typeof getServerSideProps>): JSX.Element {
            ...
            <div className="bg-white md:shadow-lg shadow-none rounded p-6 w-96 ">
              ...
              <section className="space-y-5 mt-5">
                ...
                {providers && Object.values(providers).map(provider => (
                  ...
                  >
                    <h1 className="text-center text-xl text-blue-700">Sign in with {provider.name}</h1>
                  </button>
