  ...
  return (
    ...
    >
      <div className="flex h-fit min-h-screen w-full flex-col gap-y-4 bg-white p-4">
        <div className="flex h-[96vh] flex-[1_0_0] flex-col items-center justify-center self-stretch rounded-3xl border-2 border-dashed border-(--destructive-500-main,#EF4444)">
          <div className="self-stretch text-center text-base font-semibold not-italic leading-6 text-(--neutral-400,#A3A3A3)">
