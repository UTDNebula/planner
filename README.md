...
1. Make sure to replace the password in the DB Connection string with the password of the __root__ user you created while setting up MongoDB.
2. Replace the __?__ in the MongoDB connection string with its equivalent urlEncode value, i.e., __%3F__.
